...
const schema = z.object({
  ...
  cargo_length_m: z.preprocess((v) => { if (v === "" || v == null) return undefined; const n = Number(v); return Number.isNaN(n) ? undefined : n; }, z.number().min(0).max(120).optional()),
  cargo_width_m: z.preprocess((v) => { if (v === "" || v == null) return undefined; const n = Number(v); return Number.isNaN(n) ? undefined : n; }, z.number().min(0).max(15).optional()),
  cargo_height_m: z.preprocess((v) => { if (v === "" || v == null) return undefined; const n = Number(v); return Number.isNaN(n) ? undefined : n; }, z.number().min(0).max(8).optional()),
  cargo_weight_t: z.preprocess((v) => { if (v === "" || v == null) return undefined; const n = Number(v); return Number.isNaN(n) ? undefined : n; }, z.number().min(0).max(500).optional()),
