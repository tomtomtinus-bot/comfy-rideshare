...
const TermsNL = () => (
  <>
    ...
    <p><strong>Abonnement:</strong> Voor gebruik van het platform wordt een maandelijkse fee gevraagd. Alle abonnementen zijn maandelijks opzegbaar. Introductiekortingen (bijv. 50% in het eerste jaar) zijn eenmalig en vervallen automatisch bij verlenging, tenzij schriftelijk anders is overeengekomen.</p>
