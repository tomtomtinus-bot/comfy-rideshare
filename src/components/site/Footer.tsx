  ...
  return (
    <footer id="contact" className="bg-brass-deep py-16 md:py-20 px-6 md:px-8 text-parchment/60">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-12">
        <div className="max-w-sm">
          ...
          <p className="text-sm leading-relaxed">
            Methodische transportbegeleiding sinds 2012. Onze protocollen zijn
            gebouwd op architecturale betrouwbaarheid en een onveranderlijke
            zorgstandaard.
          </p>
        </div>
        <div className="grid grid-cols-2 gap-12 md:gap-16">
          <div className="space-y-4">
            ...
            <ul className="text-sm space-y-2">
              ...
              <li><a href="#" className="hover:text-brass-gold transition-colors">Veiligheid</a></li>
              <li><a href="#" className="hover:text-brass-gold transition-colors">Regio's</a></li>
            </ul>
          </div>
          <div className="space-y-4">
            ...
            <ul className="text-sm space-y-2 tabular-nums">
              ...
              <li>Prinsengracht 441</li>
              <li>1016 HX Amsterdam</li>
            </ul>
          </div>
        </div>
      </div>
      <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-parchment/10 flex flex-col md:flex-row gap-3 justify-between items-center text-[10px] uppercase tracking-widest">
        <span>© 2026 Compass &amp; Care Transport Begeleiding</span>
        <span>Navigeren met integriteit</span>
      </div>
    </footer>
  );
};
