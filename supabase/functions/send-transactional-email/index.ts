...
// Auth guard: service-role key only. This function intentionally uses verify_jwt=false
// so the gateway does not validate JWTs; we enforce service-role here in-code.
